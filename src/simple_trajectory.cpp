...
public:
  ...
  */
  control_msgs::FollowJointTrajectoryGoal armExtensionTrajectory()
  {
    ...
    goal.trajectory.points[ind].positions[1] = -1.25;
    goal.trajectory.points[ind].positions[2] = 1.92;
    goal.trajectory.points[ind].positions[3] = -2.08;
    goal.trajectory.points[ind].positions[4] = -1.66;
    goal.trajectory.points[ind].positions[5] = -1.51;
